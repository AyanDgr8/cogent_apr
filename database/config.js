...
const dbConfig = {
    ...
    database: process.env.DB_NAME || 'AGENT_REPORTS_COGENT',
...
export async function insertAgentCompleteHourly(reportData, tenant) {
    ...
    const baseColumns = [
        ...
        'total_inbound_calls', 'answered_inbound_calls', 'failed_inbound_calls',
        'total_outbound_calls', 'answered_outbound_calls', 'failed_outbound_calls',
...
ON DUPLICATE KEY UPDATE
    ...
    total_inbound_calls = VALUES(total_inbound_calls),
    answered_inbound_calls = VALUES(answered_inbound_calls),
    failed_inbound_calls = VALUES(failed_inbound_calls),
    total_outbound_calls = VALUES(total_outbound_calls),
    answered_outbound_calls = VALUES(answered_outbound_calls),
    failed_outbound_calls = VALUES(failed_outbound_calls),
...
`;
    ...
    const baseValues = [
        ...
        reportData.totalInboundCalls || 0,
        reportData.answeredInboundCalls || 0,
        reportData.failedInboundCalls || 0,
        reportData.totalOutboundCalls || 0,
        reportData.answeredOutboundCalls || 0,
        reportData.failedOutboundCalls || 0,
