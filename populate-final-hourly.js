                ...
                for (const record of report.agentTimeSlots) {
                    try {
                        ...
                        const reportData = {
                            ...
                            totalInboundCalls: record.totalInboundCalls || 0,
                            answeredInboundCalls: record.answeredInboundCalls || 0,
                            failedInboundCalls: record.failedInboundCalls || 0,
                            totalOutboundCalls: record.totalOutboundCalls || 0,
                            answeredOutboundCalls: record.answeredOutboundCalls || 0,
                            failedOutboundCalls: record.failedOutboundCalls || 0,
                            aht: record.aht || '00:00:00',
                            loginTime: record.loginTime || '00:00:00',
                            availableTime: record.availableTime || '00:00:00',
